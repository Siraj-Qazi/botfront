...
It is important to note that in order to support Botfront core features, such as forms, flowchart UI and multilingualism, Botfront requires a forked version of Rasa that we maintain. Botfront will not work with canonical Rasa, but you can always export your projects from Botfront if you want to use it with the standard Rasa runtime.
...
Install Botfront on your [local machine](/docs/installation/local-machine), on [remote servers or clusters](/docs/installation/remote)
